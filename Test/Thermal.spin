...
PUB Start(PinTpaSDA, PinTpaSCL) : Success | pix
' ------------------------------------------------------------------------------
' Start
' ------------------------------------------------------------------------------
{{
  Starts the Thermal object in a seperate cog. Pass the pin numbers that are
  connected to the SCL and SDA lines of the TPA81.
...
PUB Start2(PinTpaSDA, PinTpaSCL, HorzPosPtr, VertPosPtr) : Success | pix
' ------------------------------------------------------------------------------
' Start2
' ------------------------------------------------------------------------------
{{
  Starts the Thermal object in a seperate cog. Pass the pin numbers that are
  connected to the SCL and SDA lines of the TPA81. Pass pointers to vertical
  and horizontal servo positions,
  Returns a true if the startup was successful.
}}
  ...
  m_HorzPos := HorzPosPtr
  m_VertPos := VertPosPtr
...
PUB Track(ThresholdType, ThresholdTemp, HorzPosPtr, VertPosPtr) : Success
{{
  Starts thermal tracking in a separate cog. Main thermal must be started first.
  Pass pointers to vertical and horizontal servo positions,
  and threshold type (0 = hot, 1 = cold) and temperature.
...
PUB ScanAndTrack(ThresholdType, ThresholdTemp, HorzPosPtr, VertPosPtr) : Success
{{
